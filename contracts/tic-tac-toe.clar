;; title: tic-tac-toe
;; version: 1.0.0
;; summary: A PvP Tic Tac Toe game on Stacks with STX betting
;; description: Players can create games, join games, and play turn-based Tic Tac Toe with STX betting. Winner takes all.
